...
///
/// ```rust,ignore
/// async fn create_user(body: UserIn) -> impl IntoResponse {
///     let user = db.create(body).await?;
///     created(user)
/// }
/// ```
pub fn created<T: Serialize>(data: T) -> Created<T> {
    Created(data)
}
...
///
/// ```rust,ignore
/// async fn delete_user(id: i64) -> impl IntoResponse {
///     db.delete(id).await?;
///     no_content()
/// }
/// ```
...
/// Create a JSON response with 200 OK
///
/// # Example
///
/// ```rust,ignore
/// async fn get_user(id: i64) -> impl IntoResponse {
///     let user = db.get(id).await?;
///     json(user)
/// }
/// ```
pub fn json<T: Serialize>(data: T) -> impl IntoResponse {
    crate::extract::Json(data)
}

/// Create a plain text response
pub fn text(content: impl Into<String>) -> impl IntoResponse {
