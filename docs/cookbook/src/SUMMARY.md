...
- [Part III: Crate Deep Dives](crates/README.md)
    ...
    - [rustapi-extras: The Toolbox](crates/rustapi_extras.md)
        - [TOON (LLM Format)](crates/rustapi_toon.md)
        - [Template Engine (View)](crates/rustapi_view.md)
        - [Background Jobs](crates/rustapi_jobs.md)
...
- [Part IV: Recipes](recipes/README.md)
    ...
    - [Session-Based Authentication](recipes/session_auth.md)
    - [OAuth2 Client](recipes/oauth2_client.md)
    - [OIDC & OAuth2 in Production](recipes/oidc_oauth2_production.md)
    ...
    - [Custom Extractors](recipes/custom_extractors.md)
    - [Custom Middleware](recipes/custom_middleware.md)
    - [Error Handling](recipes/error_handling.md)
    - [Axum -> RustAPI Migration](recipes/axum_migration.md)
    - [Actix-web -> RustAPI Migration](recipes/actix_migration.md)
    ...
    - [MCP In-Process Invocation](recipes/mcp_in_process.md)
    - [OpenAPI to MCP CLI](recipes/mcp_openapi_cli.md)
    - [MCP stdio Transport](recipes/mcp_stdio.md)
